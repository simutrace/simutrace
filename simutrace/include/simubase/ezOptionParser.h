...
public:
  ...
  enum OP { OP_NOOP=0,
    ...
    OP_GT, /* value > list[0] */
    OP_GE, /* value >= list[0] */
    OP_GTLT, /* list[0] < value < list[1] */
    OP_GELT, /* list[0] <= value < list[1] */
    OP_GELE, /* list[0] <= value <= list[1] */
  ...
  switch(nop) {
    ...
    case 4:
      switch(_op[1]) {
        case 'e':
          switch(_op[3]) {
            case 'e': op = OP_GELE; break;
            default: op = OP_GELT; break;
          }
          break;
        default:
          switch(_op[3]) {
            case 'e': op = OP_GTLE; break;
            default: op = OP_GTLT; break;
          }
          break;
      }
      break;
